...
export interface ItemModelInterface  extends MenuItem{
  ...
  build?(item: {}):(item:{})=>ItemModelInterface;
  
  load?(next?: () => void):undefined; // load the item from firebase
  isArchived?(): boolean;
  archiveItem?(b: boolean):undefined;
  ...
  getEditPopup(item?: ItemModelInterface, service?: ItemServiceInterface):undefined;
